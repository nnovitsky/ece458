        ...
        <div className="check-div">
            <Form className="check-form">
                <Form.Group className="form-inline">
                    ...
                    <Form.Check className="col-sm" id={'calibration_approver'+ props.pk} name="calibration_approver" disabled={adminCheck} label="Cal. Approval" type="checkbox" onChange={(privilege) => { props.onChange(mapObjectToArray(privilege, props.pk, props.groups)) }} checked={approvalCheck}></Form.Check>
                    <Form.Check className="col-sm" id={'calibrations'+ props.pk} name="calibrations" disabled={adminCheck || approvalCheck} label="Calibration" type="checkbox" onChange={(privilege) => { props.onChange(mapObjectToArray(privilege, props.pk, props.groups)) }} checked={caliCheck}></Form.Check>
                </Form.Group>
            </Form>
        </div>
    )
