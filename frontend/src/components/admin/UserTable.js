...
class UserTable extends React.Component {
    ...
    render() {
        let countStart = (this.props.pagination.page - 1) * this.props.pagination.sizePerPage + 1;
        let config = this.makeConfig(countStart, this.props.deleteUser, this.props.currentUser, this.props.onChangePrivileges);
        return (
            <div>
                <DataTable
                    ...
                    config={config}
                    noResults='No Users'
                    inlineElements={this.props.inlineElements}
    ...
    makeConfig(countStart, deleteUser, currentUser, onChangePrivileges) {
        return (
            [
