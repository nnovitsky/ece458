                ...
                <div className="row">
                    <div className="col">
                        <Form.Group className="form-inline" style={{ marginTop: "20px" }}>
                            ...
                            <Button onClick={this.onSetSourceClicked}>Click to set the source</Button>
                        </Form.Group>
                        <Form.Group className="form-inline">
                            <Form.Label className="col-sm-6 col-form-label">2. Enter the displayed voltage on the Model 87</Form.Label>
                            <Form.Control type="text" value={this.state.displayVoltage} onChange={this.onTextInput} />
                            <p className="col-sm-11">The Model 87 should now display 3.500+-0.001. If necessary, adjust R21 to obtain the propper display</p>
                        </Form.Group>
                        <Form.Group className="form-inline">
                            <Form.Label className="col-sm-6 col-form-label">3. Set the Model 87 to the V~ function</Form.Label>
                            <Form.Check id="set_function" label="Check when completed" onChange={this.onSetFunction} disabled={false}></Form.Check>
                        </Form.Group>
                    </div>
                    <div className="col">
